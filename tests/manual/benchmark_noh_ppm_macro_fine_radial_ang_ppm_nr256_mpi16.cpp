...
#define DEC3D_NOH_MPI24_MACRO_RADIAL_PPM 0
#define DEC3D_NOH_MPI24_MACRO_THETA_PPM 1
#define DEC3D_NOH_MPI24_MACRO_PHI_PPM 1
#define DEC3D_NOH_MPI24_OUTPUT_DIR_LITERAL \
  "F:\\dec3d\\analysis\\output\\case_noh_spherical_ppm_macro_fine_radial_ang_ppm_nr256_p1e6_mpi16"
#define DEC3D_NOH_MPI24_CASE_NAME_LITERAL \
  "case_noh_spherical_ppm_macro_fine_radial_ang_ppm_nr256_p1e6_mpi16"
#define DEC3D_NOH_MPI24_MESH_HANDLE_LITERAL \
  "mesh:p1.noh.ppm-macro.fine-radial-ang-ppm.nr256.mpi16"
#define DEC3D_NOH_MPI24_DIAGNOSTICS_HANDLE_LITERAL \
  "diagnostics:p1.hydro.noh.ppm-macro.fine-radial-ang-ppm.nr256.mpi16"
