  ...
  try {
    ...
    if (rank == 0) {
      ...
      const dec3d::core::StageContext context{
          ...
          "p1-v0.1",
          "mesh:p1.case3.low-mode-mpi-real",
          "ownership:rank0",
          "diagnostics:p1.hydro.case3.mpi-real"};
      ...
      const auto radial_only_result = dec3d::hydro::AdvanceStaticGridHydro(
          ...
          geometry,
          kDt,
          dec3d::hydro::StaticGridHydroOptions{true, true, false, false});
      ...
      const std::filesystem::path output_dir =
          "F:\\dec3d\\analysis\\output\\case3_true3d_low_mode_mpi_real";
      ...
      DEC3D_CHECK(dec3d::hydro::WriteTrue3DLowModeOutputs(
          ...
          &mpi_parity,
          &single_rank_budget,
          "case3_true3d_low_mode_mpi_real"));
      ...
      DEC3D_CHECK(summary_text.find("case=case3_true3d_low_mode_mpi_real") != std::string::npos);
