  ...
  try {
    ...
    if (rank == 0) {
      ...
      const dec3d::core::StageContext context{
          ...
          "p1-v0.1",
          "mesh:p1.case2.macro-zoning-mpi-real",
          "ownership:rank0",
          "diagnostics:p1.hydro.case2.macro-zoning.mpi-real"};
      ...
      DEC3D_CHECK(HasDiagnosticCode(single_rank_result.diagnostics, "p1.hydro.macro_zoning.detected"));
      ...
      DEC3D_CHECK(summary.macro_zoning_executed);

      const std::filesystem::path output_dir =
          "F:\\dec3d\\analysis\\output\\case2_radial_wave_mpi_real_macro";
      ...
      DEC3D_CHECK(dec3d::hydro::WriteSphericalRadialWaveMpiParityOutputs(
          ...
          &single_rank_budget,
          &multi_rank_budget,
          "case2_radial_wave_mpi_real_macro"));
      ...
      DEC3D_CHECK(summary_text.find("case=case2_radial_wave_mpi_real_macro") != std::string::npos);
