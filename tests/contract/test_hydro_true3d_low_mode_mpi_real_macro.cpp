...
int main(int argc, char** argv) {
  ...
  try {
    ...
    constexpr std::size_t kShellIndex = 2u;
    ...
    const auto local_result = dec3d::hydro::AdvanceStaticGridHydro(
        ...
        kDt,
        local_override,
        dec3d::testsupport::MacroZoningActiveOptions());
    ...
    DEC3D_CHECK(HasDiagnosticCode(local_result.diagnostics, "p1.hydro.direction.theta"));
    DEC3D_CHECK(HasDiagnosticCode(local_result.diagnostics, "p1.hydro.direction.phi"));
    ...
    if (rank == 0) {
      ...
      hydro.SetStaticGridOptions(dec3d::testsupport::MacroZoningActiveOptions());
      const dec3d::core::StageContext context{
          ...
          "p1-v0.1",
          "mesh:p1.case3.low-mode-mpi-real-macro",
          "ownership:rank0",
          "diagnostics:p1.hydro.case3.mpi-real-macro"};
      ...
      DEC3D_CHECK(HasDiagnosticCode(single_rank_stage_result.diagnostics, "p1.hydro.macro_zoning.detected"));
      ...
      const auto radial_only_result = dec3d::hydro::AdvanceStaticGridHydro(
          ...
          geometry,
          kDt,
          dec3d::hydro::StaticGridHydroOptions{false, true, false, false});
      ...
      mpi_parity.reconstruction_mode = "macro_zoning_mpi_real_first_order_angular";
      mpi_parity.macro_zoning_mode = "mpi_real_first_order_angular_macro";
      ...
      const std::filesystem::path output_dir =
          "F:\\dec3d\\analysis\\output\\case3_true3d_low_mode_mpi_real_macro";
      ...
      DEC3D_CHECK(dec3d::hydro::WriteTrue3DLowModeOutputs(
          ...
          &mpi_parity,
          &single_rank_budget,
          "case3_true3d_low_mode_mpi_real_macro"));
      ...
      DEC3D_CHECK(summary_text.find("case=case3_true3d_low_mode_mpi_real_macro") != std::string::npos);
      ...
      DEC3D_CHECK(summary_text.find("reconstruction_mode=macro_zoning_mpi_real_first_order_angular") != std::string::npos);
      ...
      DEC3D_CHECK(manifest_text.find("reconstruction_mode=macro_zoning_mpi_real_first_order_angular") != std::string::npos);
      DEC3D_CHECK(manifest_text.find("macro_zoning_mode=mpi_real_first_order_angular_macro") != std::string::npos);
      ...
      DEC3D_CHECK(parity_text.find("reconstruction_mode=macro_zoning_mpi_real_first_order_angular") != std::string::npos);
      DEC3D_CHECK(parity_text.find("macro_zoning_mode=mpi_real_first_order_angular_macro") != std::string::npos);
    }
