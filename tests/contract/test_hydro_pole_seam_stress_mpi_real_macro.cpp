...
int main(int argc, char** argv) {
  ...
  try {
    ...
    DEC3D_CHECK(HasDiagnosticCode(local_result.diagnostics, "p1.hydro.macro_zoning.prolong.executed"));
    ...
    if (rank == 0) {
      ...
      const dec3d::core::StageContext context{
          ...
          "p1-v0.1",
          "mesh:p1.case4.pole-stress-mpi-real-macro",
          "ownership:rank0",
          "diagnostics:p1.hydro.case4.mpi-real-macro"};
      ...
      const std::filesystem::path output_dir =
          "F:\\dec3d\\analysis\\output\\case4_pole_seam_stress_mpi_real_macro";
      ...
      DEC3D_CHECK(dec3d::hydro::WritePoleAdjacentSeamStressOutputs(
          ...
          &mpi_parity,
          &single_rank_budget,
          "case4_pole_seam_stress_mpi_real_macro"));
      ...
      DEC3D_CHECK(summary_text.find("case=case4_pole_seam_stress_mpi_real_macro") != std::string::npos);
